...
#ifndef BOLT_VM_RUNTIME_H
#define BOLT_VM_RUNTIME_H

#include "bolt/vm_core.h"
#include "bolt/as_linker.h"
#include "bolt/vm_runtime_details.h"
#include <string>
...
namespace bolt { namespace vm
{
    ...
    hatch runtime_generate_hatch(std::string const& name)
    {
        hatch htc;
        htc.name = name;
